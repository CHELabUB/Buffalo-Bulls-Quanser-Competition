...
# ackowledgement: the visualization of this code and stanley control is developed with the help of Copilot, need to further improve. 
    ...
    def image_callback(self, msg):
        ...
        try:
            ...
            if len(line_detected) > 2:
                ...
                draw_line_from_xz(x_cam, z_cam, (255,0,0))
                ...
                # Stanley steering from planned 2D trajectory
                if mode != "insufficient":
